<div id="pantallaConversaciones" class="container bg-light text-dark shadow " style="font-family: 'Righteous', sans-serif;">
    <br/>
    <h1>
...
<form class='fixed-bottom bg-dark p-3'>
    <div class='row align-items-center'>
        ...
        <div class='col-md-1 text-center'>
            <button id="botonEnviar" class="btn btn-primary"><h6 class="m-2"><i class="fa fa-envelope-o"
