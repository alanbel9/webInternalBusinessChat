<div class="container bg-light text-dark shadow" style="font-family: 'Righteous', sans-serif;min-height:90vh;">
...
<form class='fixed-bottom bg-dark p-3'>
    <div class='row align-items-center'>
        <div class='col-md-1'></div>
        <div class='col-md-9'>
            <textarea id="mensajeEnviar" type="text" class="form-control w-100 mb-1" id="mensaje" placeholder="Mensaje"
                rows="2"></textarea>
        </div>
