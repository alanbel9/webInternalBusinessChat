 ...
 */
final class Version20190829082512 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuarios ADD foto_archivo LONGBLOB NOT NULL, CHANGE Password Password VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuarios DROP foto_archivo, CHANGE Password Password VARCHAR(100) NOT NULL COLLATE utf8_general_ci');
