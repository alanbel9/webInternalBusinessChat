 ...
 */
final class Version20190823174720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conversa (Id INT AUTO_INCREMENT NOT NULL, Mensaje LONGTEXT DEFAULT NULL, Fecha DATETIME DEFAULT CURRENT_TIMESTAMP, Id_Us INT DEFAULT NULL, Id_Canal INT DEFAULT NULL, INDEX Id_Us (Id_Us), INDEX Id_Canal (Id_Canal), PRIMARY KEY(Id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
