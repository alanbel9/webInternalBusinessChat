 ...
 */
final class Version20190905083533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuarios ADD fechamodificacion DATE NOT NULL, CHANGE Password Password VARCHAR(100) DEFAULT NULL, CHANGE foto_archivo foto_archivo LONGBLOB NOT NULL');
