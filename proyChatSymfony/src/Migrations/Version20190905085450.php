 ...
 */
final class Version20190905085450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE canales ADD fecha_modificacion DATETIME NOT NULL, CHANGE Imagen Imagen LONGBLOB NOT NULL');
        $this->addSql('DROP INDEX idx_usu_correo ON usuarios');
        $this->addSql('ALTER TABLE usuarios CHANGE Password Password VARCHAR(100) DEFAULT NULL, CHANGE foto_archivo foto_archivo LONGBLOB NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE canales DROP fecha_modificacion, CHANGE Imagen Imagen BLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE conversa CHANGE Id_Us Id_Us INT DEFAULT NULL, CHANGE Id_Canal Id_Canal INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE usuarios CHANGE Password Password VARCHAR(100) NOT NULL COLLATE utf8_general_ci, CHANGE foto_archivo foto_archivo BLOB DEFAULT NULL');
