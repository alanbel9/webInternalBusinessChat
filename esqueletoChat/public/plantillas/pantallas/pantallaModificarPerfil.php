...
<div class="">  
       ...
       <div class="row">
               <div class=" rounded mx-auto d-block">
                       <img id="imgSalida" width="" height="300" src="../resources/foto-carnet.jpg" class="rounded" alt="foto perfil">
       ...
       <div class="row">
                ...
                <div class="col-md-2  mt-2">
                       <button class="btn btn-primary btn-block " type=""> Subir imagen </button>
                </div>              
        </div>
...
<div class="">  
       <div class="row">
               <div class="input-group  col-md-3 offset-md-3 mt-2">
       ...
       <div class="row">
               <div class="input-group  col-md-3 offset-md-3 mt-2">
                        <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon3">Fecha nac.</span>
                        </div>
